...
import { createReactiveConnection, createSharedRivetKit, withActorParams, getActionError, } from "../index.js";
import { createMockConnection } from "./helpers.js";
describe("shared helpers", () => {
    test("createSharedRivetKit reuses a single wrapper", () => {
        const client = { id: "client" };
        let clientCalls = 0;
        const getRivet = createSharedRivetKit(() => {
            clientCalls += 1;
            return client;
        });
        const a = getRivet();
